                    ...
                    <div className="p-2">
                      {getMacrorregioes().map(macro => {
                        ...
                        const filteredMicros = micros.filter(m =>
                          m.nome.toLowerCase().includes(microSearchTerm.toLowerCase())
                        );

                        if (filteredMicros.length === 0) return null;
                      ...
                      {/* Empty State */}
                      {microSearchTerm && getMacrorregioes().every(macro =>
                        getMicroregioesByMacro(macro).filter(m =>
                          m.nome.toLowerCase().includes(microSearchTerm.toLowerCase())
                        ).length === 0
                      ) && (
